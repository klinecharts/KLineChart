...
const logarithm: AxisTemplate = {
  ...
  valueToRealValue: (value) => log10(value),
  realValueToDisplayValue: (value) => index10(value),
  displayValueToRealValue: (value) => log10(value),
  realValueToValue: (value) => index10(value),
