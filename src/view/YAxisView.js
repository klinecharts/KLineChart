 ...
 */
 ...
 export default class YAxisView extends View {
   ...
   _drawMarkLabel (
     ...
     {
       size, weight, family, color, backgroundColor, cornerWidth,
     ...
     const rectWidth = calcTextWidth(this._ctx, text) + paddingLeft + paddingRight + cornerWidth
     ...
     renderFillRectWithCorner(
       ...
       rectStartX, valueY - paddingTop - size / 2, rectWidth, rectHeight, cornerWidth
     )
 
     this._ctx.textBaseline = 'middle'
     renderText(this._ctx, color, rectStartX + paddingLeft + cornerWidth, valueY, text)
   }
