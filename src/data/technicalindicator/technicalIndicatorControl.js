...
import AwesomeOscilator from './additional/awesomeOscilator'
import RateOfChange from './additional/rateOfChange'
import AroonIndicator from './additional/aroonIndicator'
import BullsPower from './additional/bullsPower'
import BearsPower from './additional/bearsPower'

import {
  AVP, MA, EMA, VOL, MACD, KDJ, BOLL, RSI,
  BIAS, BRAR, CCI, DMI, CR, PSY, DMA,
  TRIX, OBV, VR, WR, MTM, EMV, SAR, AO, ROC, ARO, BULLP, BEARP
...
export function createTechnicalIndicatorMapping () {
  return {
    ...
    [AO]: new AwesomeOscilator(),
    [ROC]: new RateOfChange(),
    [ARO]: new AroonIndicator(),
    [BULLP]: new BullsPower(),
    [BEARP]: new BearsPower(),
  }
}
