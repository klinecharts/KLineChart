...
- `options` Optional configuration item.
  ...
  - `styles` It can be a style name registered by `klinecharts.registerStyles` or `Styles` . For details about `Styles` , see [Styles](./styles.md). Incremental values ​​are supported.
