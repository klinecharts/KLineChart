...
var GraphicMark = /*#__PURE__*/function () {
  ...
  _createClass(GraphicMark, [{
    ...
    key: "_drawGraphic",
    value: function _drawGraphic(ctx, xyPoints, markOptions) {}
    /**
     * 绘制
     * @param ctx
     */
    ...
    value: function draw(ctx) {
      ...
      var markOptions = this._chartData.styleOptions().graphicMark;
...
var LineGraphicMark = /*#__PURE__*/function (_GraphicMark) {
  ...
  _createClass(LineGraphicMark, [{
    ...
    key: "performMarkPoints",
    value: function performMarkPoints(tpPoints, pressedPointIndex, _ref) {
    ...
    key: "checkMousePointOnLine",
    value: function checkMousePointOnLine(point1, point2, mousePoint) {}
    /**
     * 生成线
     * @param xyPoints
     * @param viewport
    ...
    key: "generatedLines",
    value: function generatedLines(xyPoints, viewport) {}
    /**
     * 绘制拓展
     * @param ctx
     * @param lines
    ...
    key: "drawExtend",
    value: function drawExtend(ctx, lines, markOptions, precision, xAxis, yAxis) {}
  }, {
    key: "_drawGraphic",
    value: function _drawGraphic(ctx, xyPoints, markOptions) {
      ...
      this.drawExtend(ctx, lines, markOptions, {
...
var TwoPointLineGraphicMark = /*#__PURE__*/function (_OnePointLineGraphicM) {
  ...
  _createClass(TwoPointLineGraphicMark, [{
        ...
        case GraphicMarkDrawStep.STEP_2:
          {
            ...
            this.onMouseMoveForDrawingExtend(this._tpPoints, {
              timestamp: timestamp,
              price: price,
              dataIndex: dataIndex
            });
    ...
    key: "onMouseMoveForDrawingExtend",
    value: function onMouseMoveForDrawingExtend(tpPoints, _ref) {
      var timestamp = _ref.timestamp,
          price = _ref.price,
          dataIndex = _ref.dataIndex;
    }
...
function createGraphicMarkMapping() {
  var mapping = {};
  var markExtensions = extension.markExtensions;

  for (var name in markExtensions) {
    var markClass = createMarkClass(markExtensions[name]);
...
function createMarkClass(_ref) {
  var name = _ref.name,
      series = _ref.series,
      checkMousePointOnLine = _ref.checkMousePointOnLine,
      generatedLines = _ref.generatedLines,
      performMarkPoints = _ref.performMarkPoints,
      onMouseMoveForDrawingExtend = _ref.onMouseMoveForDrawingExtend,
      drawExtend = _ref.drawExtend;

  if (!name || !series || !isFunction(checkMousePointOnLine) || !isFunction(generatedLines)) {
    {
      console.warn('Required attribute "name" and "series", method "checkMousePointOnLine" and "generatedLines", new graphic mark cannot be generated!!!');
    }
  ...
  if (ExtendClass) {
    var Mark = /*#__PURE__*/function (_ExtendClass) {
      _inherits(Mark, _ExtendClass);
...
var ChartData = /*#__PURE__*/function () {
  ...
  _createClass(ChartData, [{
    ...
    value: function addCustomTechnicalIndicator(technicalIndicatorInfo) {
      var technicalIndicator = createTechnicalIndicatorInstance(technicalIndicatorInfo || {});
...
var ChartPane = /*#__PURE__*/function () {
  ...
  _createClass(ChartPane, [{
    ...
    key: "createPane",
    value: function createPane(type) {
      ...
      var id = "".concat(TECHNICAL_INDICATOR_NAME_PREFIX).concat(this._technicalIndicatorBaseId);
    ...
    key: "removeTechnicalIndicator",
    value: function removeTechnicalIndicator(technicalIndicatorType, paneId) {
      if (paneId) {
        var panePos = -1;
          ...
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            if (pane.id() === paneId) {
              return pane.technicalIndicators().map(function (technicalIndicator) {
                return technicalIndicator.name;
              });
            }
          }
        } catch (err) {
...
function init(ds) {
  ...
  var errorMessage = 'Chart version is 6.1.0. The chart cannot be initialized correctly. Please check the parameters. The chart container cannot be null and child elements need to be added!!!';
  var container;
...
var horizontalRayLine = {
  ...
  series: 'twoPointLine',
  checkMousePointOnLine: function checkMousePointOnLine(point1, point2, mousePoint) {
    return checkPointOnRayLine(point1, point2, mousePoint);
  },
  generatedLines: function generatedLines(xyPoints, viewport) {
    var point = {
      x: 0,
      y: xyPoints[0].y
    };
  ...
  performMarkPoints: function performMarkPoints(tpPoints, pressedPointIndex, _ref) {
    var dataIndex = _ref.dataIndex,
        timestamp = _ref.timestamp,
        price = _ref.price;
    tpPoints[pressedPointIndex].timestamp = timestamp;
  ...
  onMouseMoveForDrawingExtend: function onMouseMoveForDrawingExtend(tpPoints, _ref2) {
...
var horizontalSegment = {
  ...
  generatedLines: function generatedLines(xyPoints) {
...
var horizontalStraightLine = {
  ...
  generatedDrawLines: function generatedDrawLines(xyPoints, viewport) {
    return [[{
      x: 0,
      y: xyPoints[0].y
    }, {
...
var priceLine = {
  ...
  drawExtend: function drawExtend(ctx, lines, markOptions, precision, xAxis, yAxis) {
    var point = lines[0][0];
    var price = yAxis.convertFromPixel(point.y);
    var priceText = formatPrecision(price, precision.price);
...
var fibonacciLine = {
  ...
  drawExtend: function drawExtend(ctx, lines, markOptions, precision, xAxis, yAxis) {
    ...
    lines.forEach(function (points, index) {
      var point = points[0];
      var price = yAxis.convertFromPixel(point.y);
      var priceText = "".concat(formatPrecision(price, precision.price), " ").concat(percentTextArray[index]);
      ctx.fillText(priceText, point.x + markOptions.text.marginLeft, point.y - markOptions.text.marginBottom);
    });
  }
};
 ...
 * limitations under the License.
 */
extension.addMark([horizontalRayLine, horizontalSegment, horizontalStraightLine, verticalRayLine, verticalSegment, verticalStraightLine, rayLine, segment, straightLine, parallelStraightLine, priceChannelLine, priceLine, fibonacciLine]);
